...
Great script from http://blogs.msdn.com/b/repltalk/archive/2010/02/24/decrypting-schema-option-parameters-binary-value-for-a-transactional-replication-article.aspx

Shows all the schema options of an article in a meaningful way...

Get schema_option with sp_help article (run in DB where the publication comes from)
          sp_helparticle @Publication='<publication_name>'
...
SET @schemaoption   = 0x00000000000000F7     ---Replace the value here
------------------------------
SET NOCOUNT ON
