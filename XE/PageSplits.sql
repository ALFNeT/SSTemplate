...
IF EXISTS ( SELECT  1
            ...
            WHERE   name = 'PageSplits_Histogram' )
    DROP EVENT SESSION [PageSplits_Histogram] ON SERVER

CREATE EVENT SESSION [PageSplits_Histogram] ON SERVER
...
ALTER EVENT SESSION [PageSplits_Histogram]
ON SERVER
STATE=START;
GO
